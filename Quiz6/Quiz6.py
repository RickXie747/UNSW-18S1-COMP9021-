...
class Triangle:
    def __init__(self, *, point_1, point_2, point_3):
        if (point_1.x == point_2.x and point_1.y == point_2.y) or \
                (point_1.x == point_3.x and point_1.y == point_3.y) or \
                (point_2.x == point_3.x and point_2.y == point_3.y):
            raise TriangleError('Incorrect input, triangle not created.')
        if (point_1.y - point_2.y) / (point_1.x - point_2.x) == (point_1.y - point_3.y) / (point_1.x - point_3.x):
            raise TriangleError('Incorrect input, triangle not created.')
    ...
    def change_point_or_points(self, *, point_1=None, point_2=None, point_3=None):
        if point_1 is not None:
            if (point_1.y - self.point_2.y) * (point_1.x - self.point_3.x) == \
                            (point_1.y - self.point_3.y) * (point_1.x - self.point_2.x) \
                    or \
                    (point_1.x == self.point_2.x and point_1.y == self.point_2.y) or \
                    (point_1.x == self.point_3.x and point_1.y == self.point_3.y):
                print('Incorrect input, triangle not modified.')
            else:
                self.point_1 = point_1
        if point_2 is not None:
            if (point_2.y - self.point_1.y) * (point_2.x - self.point_3.x) == \
                            (point_2.y - self.point_3.y) * (point_2.x - self.point_1.x) \
                    or \
                    (point_2.x == self.point_1.x and point_2.y == self.point_1.y) or \
                    (point_2.x == self.point_3.x and point_2.y == self.point_3.y):
                print('Incorrect input, triangle not modified.')
            else:
                self.point_2 = point_2
        if point_3 is not None:
            if (point_3.y - self.point_2.y) * (point_3.x - self.point_1.x) == \
                            (point_3.y - self.point_1.y) * (point_3.x - self.point_2.x) \
                    or \
                    (point_3.x == self.point_2.x and point_3.y == self.point_2.y) or \
                    (point_3.x == self.point_1.x and point_3.y == self.point_1.y):
                print('Incorrect input, triangle not modified.')
            else:
                self.point_3 = point_3
        self.perimeter, self.area = self.get_perimeter_area()
